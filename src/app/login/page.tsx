    ...
    <main className="min-h-screen bg-softwhite text-navy pt-40 pb-24 px-6 flex flex-col items-center justify-center">
      <div className="w-full max-w-md bg-white p-8 md:p-12 rounded-2xl shadow-xl border border-navy/5">
        ...
        <button 
          ...
          className="w-full flex items-center justify-center gap-3 py-4 border border-navy/20 text-navy font-bold text-xs uppercase tracking-widest hover:bg-navy/5 transition-colors mb-6 group"
        >
        ...
        <p className="text-center text-xs font-bold uppercase tracking-widest text-navy/50 mt-8">
          New to Luxen?
          <Link href="/register" className="text-navy hover:text-blue-600 ml-2 transition-colors">
            Create Account
          </Link>
        </p>
      </div>
